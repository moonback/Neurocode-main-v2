...
export const SETTING_IDS = {
  ...
  smartContextStrategy: "setting-smart-context-strategy",
...
export const SETTINGS_SEARCH_INDEX: SearchableSettingItem[] = [
  ...
  {
    id: SETTING_IDS.smartContextStrategy,
    label: "Smart Context Strategy",
    description:
      "Choose how aggressively the AI includes files in context (conservative, balanced, or deep)",
    keywords: [
      "smart",
      "context",
      "strategy",
